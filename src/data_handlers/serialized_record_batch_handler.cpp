...
SerializedRecordBatchHandler::SerializedRecordBatchHandler(std::shared_ptr<RecordBatchHandler> handler_strategy)
    : handler_strategy_(std::move(handler_strategy)) {

}

arrow::Status SerializedRecordBatchHandler::handle(const std::shared_ptr<arrow::Buffer>& source,
